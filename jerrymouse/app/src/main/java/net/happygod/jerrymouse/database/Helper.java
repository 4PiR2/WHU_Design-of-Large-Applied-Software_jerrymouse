...
class Helper extends SQLiteOpenHelper
{
	...
	public void onCreate(SQLiteDatabase db)
	{
		...
		sql[4]="INSERT INTO link VALUES"
		       //+ "(0,'/',2,'',0,0,0,''),"
		       + "(1998,'',1,1,'',0,0,0,'',NULL),"
		       + "(1998,'/DBManager',1,NULL,NULL,NULL,NULL,3,'DBManager.dex',NULL),"
		       + "(1998,'/DBManager.dex',1,0,NULL,NULL,NULL,NULL,NULL,NULL),"
		       + "(8080,'',1,2,'',1,1,0,'',NULL),"
		       ...
		       + "(8050,'',1,2,'dXNlcm5hbWU6cGFzc3dvcmQ=',1,1,0,'',NULL),"
		       + "(8000,'',1,2,'dXNlcm5hbWU6cGFzc3dvcmQ=',1,1,0,'',NULL)"
		       + ";";
