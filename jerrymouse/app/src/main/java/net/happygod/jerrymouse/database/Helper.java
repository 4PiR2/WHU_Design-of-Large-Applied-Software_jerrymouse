...
class Helper extends SQLiteOpenHelper
{
	...
	public void onCreate(SQLiteDatabase db)
	{
		...
		db.execSQL(sql);
		sql="INSERT INTO general VALUES(0,1,8080,'/storage/emulated/0/web',0,1,1),(1,1,8000,null,1,0,0),(2,1,8010,'localhost:8000',1,0,0),(3,1,8020,'localhost:8080',1,0,0),(4,1,8020,null,0,0,0);";
		db.execSQL(sql);
